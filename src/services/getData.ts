		...
		schedules: [
			{
				id: 1007,
				name: "放送日",
				start_at: "2024-08-05T21:00:00Z",
				end_at: "2024-08-05T22:00:00Z",
				status: "upcoming",
			},
		],
		...
		schedules: [
			{
				id: 1008,
				name: "出演日",
				start_at: "2024-08-12T15:00:00Z",
				end_at: "2024-08-12T16:30:00Z",
				status: "upcoming",
			},
		],
		relatedTalents: [{ id: 1, name: "タレントA" }],
		...
		schedules: [
			{
				...
				end_at: "2024-09-15T23:59:59Z",
				status: "upcoming",
			},
			{
				id: 1010,
				name: "イベント日",
				start_at: "2024-10-10T13:00:00Z",
				end_at: "2024-10-10T17:00:00Z",
				status: "upcoming",
			},
		],
		relatedTalents: [{ id: 1, name: "タレントA" }],
		...
		schedules: [
			{
				id: 1011,
				name: "発売日",
				start_at: "2024-09-25T00:00:00Z",
				end_at: "2024-09-25T23:59:59Z",
				status: "upcoming",
			},
		],
		relatedTalents: [{ id: 1, name: "タレントA" }],
		...
		schedules: [
			{
				id: 1013,
				name: "予約開始",
				start_at: "2024-11-15T00:00:00Z",
				end_at: "2024-12-14T23:59:59Z",
				status: "upcoming",
			},
			{
				id: 1014,
		...
		schedules: [
			{
				id: 1016,
				name: "開催日",
				start_at: "2025-02-11T18:00:00Z",
				end_at: "2025-02-11T21:00:00Z",
				status: "upcoming",
			},
		],
		relatedTalents: [{ id: 1, name: "タレントA" }],
...
const talents = talentAEvent
	.flatMap((event) => event.relatedTalents)
	.reduce((acc, talent) => {
