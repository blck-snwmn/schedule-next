...
export const Events: React.FC<{ scheduleEvent: ScheduleEvent[], talents: Talent[] }> = ({ scheduleEvent, talents }) => {
    const [selectedTalent, setSelectedTalent] = useState<Talent | null>(null);
    const [filteredEvents, setFilteredEvents] = useState<ScheduleEvent[]>(scheduleEvent);

    useEffect(() => {
        if (selectedTalent) {
            setFilteredEvents(scheduleEvent.filter(event =>
